...
| [16 — Gate 5, the review screen](story/16-gate-5-review-screen.md) | Three directions for the hero view in one component — the evidence sidebar, the calm document, the inspect canvas — rendered, debated by a second model, picked | — |
