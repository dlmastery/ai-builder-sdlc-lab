...
- **15:41** — the watchdog killed the API and the web server a third time. Relaunched both **detached**, the way the training run was (D-025): the watchdog reaps what the harness owns, and nothing else. Both answer.
